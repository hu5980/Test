...
enum HMSelectionIndicatorPosition{
    HMSelectionIndicatorTop                  = 0,
    HMSelectionIndicatorBottom
};
...
@property (nonatomic, strong) UIColor *sepColor;  //分隔符
@property (nonatomic, strong) UIColor *textColor; // default is [UIColor blackColor]
@property (nonatomic, strong) UIColor *textSelectedColor;//文字被选中时候的颜色 default is [UIColor blueColor]
...
@property (nonatomic,assign) CGFloat sepViewWidth;              //分隔符宽度 default is 2.0
@property (nonatomic, readwrite) UIEdgeInsets segmentEdgeInset; // default is UIEdgeInsetsMake(0, 5, 0, 5)
@property (nonatomic,assign) enum HMSelectionIndicatorPosition selectionIndicatorPosition;
